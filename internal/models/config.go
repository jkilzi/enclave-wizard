...
type PluginsConfig struct {
	...
	OsacMetal3Namespace       *string             `json:"osacMetal3Namespace,omitempty" yaml:"osacMetal3Namespace,omitempty" doc:"Namespace where BareMetalHost CRs are located" minLength:"1"`
	OsacMetal3HostClass       *string             `json:"osacMetal3HostClass,omitempty" yaml:"osacMetal3HostClass,omitempty" doc:"Host class identifier for Metal3 inventory (default: metal3)" minLength:"1"`
